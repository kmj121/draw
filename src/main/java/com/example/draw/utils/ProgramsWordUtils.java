...
public class ProgramsWordUtils extends WordUtils {
    ...
    @Override
    public void generateWord(XWPFDocument document, Map<String, Object> params, Map<String, List<List<String>>> tableMap) throws IOException, InvalidFormatException, URISyntaxException, DocumentException {
